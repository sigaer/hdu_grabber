...
def courseList(keyW, kklxdm="01"):
    ...
    for item in CourseList:
        ...
        kch_ids.append(
            {"id": item["kch_id"], "name": item["jxbmc"], "jxb_id": item["jxb_id"]}
        )
        i = i + 1
    print("---------------------------------------------------")
            ...
            if kch_ids != []:
                ...
                if toChooseId in range(0, len(kch_ids)):
                    ...
                    if ifChoose != "n":
                        ...
                        jxb_id = kch_ids[toChooseId]["jxb_id"]
                        Detail = User.getCourseDetail(kch_id, "01", jxb_id)
                        if Detail == "0":
                            print("课程具体获取失败！")
                        else:
                            print(Detail)
                            jxb_ids = Detail["do_jxb_id"]
            ...
            if kch_ids != []:
                ...
                if toChooseId in range(0, len(kch_ids)):
                    ...
                    if ifChoose != "n":
                        kch_id = kch_ids[toChooseId]["id"]
                        jxb_id = kch_ids[toChooseId]["jxb_id"]
                        Detail = User.getCourseDetail(kch_id, "10", jxb_id)
                        if Detail == "0":
                            print("课程具体获取失败！")
                        else:
                            jxb_ids = Detail["do_jxb_id"]
            ...
            if kch_ids != []:
                ...
                if toChooseId in range(0, len(kch_ids)):
                    ...
                    if ifChoose != "n":
                        kch_id = kch_ids[toChooseId]["id"]
                        jxb_id = kch_ids[toChooseId]["jxb_id"]
                        Detail = User.getCourseDetail(kch_id, "05", jxb_id)
                        print(Detail)
                        if Detail == "0":
                            print("课程具体获取失败！")
                        else:
            ...
            if kch_ids != []:
                ...
                if toQuitId in range(0, len(kch_ids)):
                    ...
                    if ifChoose == "yes":
                        ...
                        jxb_id = kch_ids[toQuitId]["jxb_id"]
                        Detail = User.getCourseDetail(
                            kch_id, kklxdm=None, jxb_id=jxb_id
                        )
                        if Detail == "0":
                            print("课程具体获取失败！")
                        else:
