...
class Login(object):
    def __init__(self, base_url):
        ...
        self.key_url = parse.urljoin(
            base_url, '/jwglxt/xtgl/login_getPublicKey.html')
        self.login_url = parse.urljoin(
            base_url, '/jwglxt/xtgl/login_slogin.html')
    ...
    def login(self, sid, password):
        ...
        self.cookies_str = '; '.join(
            [item.name + '=' + item.value for item in self.cookies])
